...
import com.namastemart.service.impl.*;
...
Part filePart = request.getPart("profilelmage");
byte[] userlmage = null;
...
userlmage = outputStream.toByteArray();
...
UserBean user = new UserBean(name, mobile, email, address, pincode, password, userlmage, isActive);
...
request.setAttribute("message", "Profile update falled, please try again.");
