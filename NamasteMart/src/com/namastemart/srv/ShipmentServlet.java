...
pagename = "unshippedltems.jsp";


} else {

MailMessage.orderShipped(userName, new UserServicelmpl().getFName(userName), orderId, amount);
}
...
pw.println("<script>document.getElementByld('message').innerHTML='" + status +"'</script>");
