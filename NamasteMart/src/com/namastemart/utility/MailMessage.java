...
"<br>We're thrilled to have you. Check out our latest collection of products with up to 60% OFF on select
items" +
"<br><br>Enjoy free delivery on all orders and explore a wide range of top brands." +

"<br>As a welcome gift, enjoy an additional 10% OFF up to 500 on your first purchase with the promo code
below." +
...
public static void transactionSuccess(String recipientEmail, String name, String transld, double transAmount) {
...
"<br><br><font style='color:red;font-weight:bold;'>Order ID :< /font> <font
style='color:green;font-weight:bold;'>"+transld +"</font>"+
"<br><font style='color:red;font-weight:bold;'>Amount Paid :< /font> <font
style='color:green;font-weight:bold;'>" + transAmount +"</font>" +
...
JavaMailUtil.sendMail(recipient, subject, htmlTextMessage);
	...
	public static void orderShipped(String recipientEmail, String name, String transld, double transAmount) {
	...
	"<br><br>Here are your transaction details:" +
	"<br><br><font style='color:red;font-weight:bold;'>Order ID :< ifont> <font
	style='color:green;font-weight:bold;'>" +transld +"</font>" +
	"<br><font style='color:red;font-weight:bold;'>Amount Paid :< /font> <font
	style='color:green;font-weight:bold;'>" + transAmount +"</font>" +
	...
	public static void productAvailableNow(String recipientEmail, String name, String prodName, String prodld) {
	String recipient = recipientEmail;
...
"<br>We're excited to inform you that the product <strong>" + prodName +"</strong> (Product ID:
<strong>" + prodld + "</strong>) is now back in stock and available for purchase!" +
"<br><br>Product Details:" +
"<br><font style='color:red;font-weight:bold;'>Product ID :< /font> <font
style='color:green;font-weight:bold;'>"+prodld +"</font>"+
"<br><font style='color:red;font-weight:bold;'>Product Name :< /font> <font
style='color:green;font-weight:bold;'>"+prodName +"</font>"+
...
e.printStackTrace();
	...
	public static void orderCancelled(String recipientEmail, String name, String orderld, double refundAmount) {
		...
		"Hello " + Uname +"." +
		"<br><br>We regret to inform you that your order with Order ID" + orderld +" has been cancelled as per
		your request." +
		"<br><br>A refund of <font style='color:green;font-weight:bold;'>" +refundAmount +"<lfont> will be
		processed to your account shortly." +
		...
		try {
			...
			public static String sendMessage(String toEmailld, String subject, String htmlTextMessage) {
